...
https://github.com/bwalia/wslproxy/actions/workflows/qa-cypress-ui-tests.yaml
...
#### `Int`: https://api-int.wslproxy.com/

##### Sub-environments of `int` are-

- int2 : https://api-int.wslproxy.com/
- int6 : https://api-int.wslproxy.com/
- int10 : https://api-int.wslproxy.com/

#### `test`: http://api.wslproxy.com/

##### Sub-environments of `test` are-

- int2 : https://api.test2.wslproxy.com/
- int6 : https://api.test6.wslproxy.com/
