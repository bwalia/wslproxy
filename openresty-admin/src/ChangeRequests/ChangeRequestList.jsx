...
const getHeaders = () => {
  ...
  const headers = { "x-platform": "react-admin", "Content-Type": "application/json" };
...
const ChangeRequestList = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h5" sx={{ mb: 3, fontWeight: 600 }}>Change Requests</Typography>
        ...
        <DialogContent>
          {selectedCR && (
            <Box>
              ...
              {/* Rejections */}
              {selectedCR.rejections?.length > 0 && (
                <>
